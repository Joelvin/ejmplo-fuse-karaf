 ...
 * 2020-04-23T11:46:24.110-05:00
 * Generated source version: 3.3.6
 *
 */
@WebServiceClient(name = "SOATestEndpointService",
                  wsdlLocation = "file:/C:/Repositorio/fuse-karaf/ejmplo-fuse-karaf/SoapExample/src/main/resources/wsdl/test.wsdl",
...
public class SOATestEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Repositorio/fuse-karaf/ejmplo-fuse-karaf/SoapExample/src/main/resources/wsdl/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOATestEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Repositorio/fuse-karaf/ejmplo-fuse-karaf/SoapExample/src/main/resources/wsdl/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
